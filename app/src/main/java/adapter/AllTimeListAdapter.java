...
public class AllTimeListAdapter extends BaseAdapter {
    ...
    public AllTimeListAdapter(Context applicationContext,
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            vi = inflater.inflate(R.layout.alltimelistitem, null);
